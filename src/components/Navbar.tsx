...
import {
  Search, Menu, X, Sun, Moon, BookOpen,
  User, LogOut, Bookmark, Clock, ChevronDown, Leaf, FilePlus
} from "lucide-react";
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/" className="flex items-center gap-2 shrink-0">
            ...
            <div className="flex flex-col leading-none">
              ...
              <span className="text-[9px] text-gray-500 dark:text-gray-400 tracking-wide uppercase hidden sm:block">Environmental Science</span>
            </div>
          </Link>
              ...
              <div className="relative">
                ...
                {userDropOpen && (
                  <div className="absolute right-0 top-full mt-1 w-52 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl shadow-lg py-1 z-50">
                    ...
                    <Link to="/profile" className="flex items-center gap-2 px-3 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800">
                      <User className="w-4 h-4" /> Profile
                    </Link>
                    <Link to="/profile?tab=bookmarks" className="flex items-center gap-2 px-3 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800">
                      <Bookmark className="w-4 h-4" /> Saved Articles
                    </Link>
                    <Link to="/profile?tab=history" className="flex items-center gap-2 px-3 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800">
